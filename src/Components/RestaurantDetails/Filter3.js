...
//       fetch('http://localhost:8083/restaurants/filter/1',requestOptions)
//        .then(response=>response.json())
//        .then(data => {
                        ...
                        <div className="col-sm-3 col-md-3 col-lg-3">
                            <div className="filter-options">
                                ...
                                <div id="demo" className="collapse show">
                                    ...
                                    <div>
                                        <input type="radio" name="cost" 
                                         onChange={()=>handleCostChange(0,30000)}
                                         />
                                    ...
                                    <div>
                                        ...
                                        checked={filter.sort==1} onChange={()=>handleSort(1)} 
                                        />
                            ...
                            {/* <div className="col-sm-9 col-md-9 col-lg-9 scroll"> */}
                                 ...
                                 {/* <div className="row padding-left">
                                     <div className="col-sm-12 col-md-12 col-lg-12">
                                         <div className="rest-address"> */}
                                          {/* CUISINES : {item.Cuisine.length && item.Cuisine.map((item)=> item.name+' ')} */}
                                          {/* </div>
                                         <div className="rest-address"> */}
